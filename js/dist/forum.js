    ...
    this.attrs.selectedFiles.map(function (fileId) {
      ...
      try {
        if (file.id() === _this3.files[k].id) {
          ...
          flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.composer.editor.insertAtCursor('[span class="transliteratedText"]' + _this3.files[k].attributes.url + '[/span]\n\n');
          flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.composer.editor.insertAtCursor('[span class="cyrilicText"]' + _this3.files[k++].attributes.path + '[/span]\n\n');
        }
      } catch (error) {
        k++;
        flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.composer.editor.insertAtCursor(file.bbcode() + '\n\n');
