...
var DropZone = /*#__PURE__*/function (_Component) {
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.content = '';
    this.files = '';
    this.text_original = flarum_common_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(!!this.attrs.text_original);
    this.text_transliterat = flarum_common_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(!!this.attrs.text_transliterat);
    this.files = '';
    this.contor = 0;
  };
  ...
  _proto.view = function view() {
    ...
    return m("div", null, this.loading && m("div", {
    ...
    }, this.files == '' ? flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      className: "Button Button--primary button_transliterare",
      onclick: this.transliterate.bind(this),
      disabled: !this.enable,
      loading: this.loading
    }, flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('digi-media-manager.forum.dropzone.transliterate_button')) : '', this.files && m("div", {
      className: "UserFileList-text"
    }, m("h3", {
      "class": true
    }, "Textul din imagine a fost recunoscut si transliterat. Selecteaza textul/textele pentru a continua."), m("div", {
      className: "Form-group"
    }, m("div", null, m("label", {
      className: "checkbox"
    }, m("input", {
      type: "checkbox",
      bidi: this.text_original,
      oncha: true,
      disabled: this.loading
    }), flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('digi-media-manager.forum.dropzone.checkbox_text_original')), m("label", {
      className: "checkbox"
    }, m("input", {
      type: "checkbox",
      bidi: this.text_transliterat,
      disabled: this.loading
    }), flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('digi-media-manager.forum.dropzone.checkbox_text_transliterat'))))), this.files !== '' ? flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      className: "Button Button--primary button_transliterare",
      onclick: this.addFilesAndText.bind(this)
    }, flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('digi-media-manager.forum.dropzone.add_to_composer_button')) : '')), !this.uploaded && m("div", {
      className: "dropzone"
    }, m("div", {
  ...
  _proto.transliterate = function transliterate() {
    ...
    if (maxFileSize >= 5242880 && maxFileSize < 10485760) {
      // between 5 MB and 10 MB
      setTimeout(function () {
        _this2.request(params);
      }, 1000 * 90); // 90 sec. / 1.5 minutes

      return;
    }

    if (maxFileSize >= 10485760 && maxFileSize < 15728640) {
      // between 10 MB and 15 MB
      setTimeout(function () {
        _this2.request(params);
      }, 1000 * 150); // 150 sec. / 2.5 minutes

      return;
    }

    if (maxFileSize >= 15728640 && maxFileSize < 20971520) {
      // between 15 MB and 20 MB
      setTimeout(function () {
        _this2.request(params);
      }, 1000 * 300); // 300 sec. / 5 minutes

      return;
    }

    if (maxFileSize >= 20971520 && maxFileSize < 26214400) {
      // between 20 MB and 25 MB
      setTimeout(function () {
        _this2.request(params);
      }, 1000 * 400); // 400 sec. / 6,(6) minutes

      return;
    }

    if (maxFileSize >= 26214400 && maxFileSize < 52428800) {
      // between 20 MB and 50 MB
      setTimeout(function () {
        _this2.request(params);
      }, 1000 * 500); // 500 sec. / 8,(3) minutes

      return;
    }

    if (maxFileSize >= 52428800 && maxFileSize < 104857600) {
      // between 50 MB and 100 MB
      setTimeout(function () {
        _this2.request(params);
      }, 1000 * 600); // 600 sec. / 10 minutes

      return;
    }

    if (maxFileSize >= 104857600 && maxFileSize < 262144000) {
      // between 100 MB and 250 MB
      setTimeout(function () {
        _this2.request(params);
  ...
  _proto.addFilesAndText = function addFilesAndText() {
    ...
    var text_original = this.text_original();
    var text_transliterat = this.text_transliterat();
    var k = 0;
    this.attrs.selectedFiles.map(function (fileId) {
...
flarum_app__WEBPACK_IMPORTED_MODULE_4___default.a.initializers.add('block-cat/digi-media-manager', function () {
  ...
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__["override"])(__webpack_require__(/*! @fof-upload */ "@fof-upload").components.FileManagerModal.prototype, 'view', function (original) {
    return m("div", {
      ...
      className: "Button Button--primary"
    }, flarum_app__WEBPACK_IMPORTED_MODULE_4___default.a.translator.trans('fof-upload.forum.file_list.confirm_selection_btn', {
